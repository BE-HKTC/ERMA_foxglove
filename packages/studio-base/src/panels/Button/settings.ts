  ...
  message: {
    ...
    fields: {
      value: {
        ...
        help: "Payload must be a JSON object string.",
      },
    },
  },
  button: {
    label: "Button",
    fields: {
      buttonText: { label: "Title", input: "string", value: config.buttonText, placeholder: "Send" },
...
const getSampleMessage = (
  ...
  return sampleMessage != undefined ? JSON.stringify(sampleMessage) : "{}";
};

export function useButtonPanelSettings(
  config: ButtonConfig,
